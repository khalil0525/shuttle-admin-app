...
import TrainerResourceCreatorAttachmentItem from './TrainerResourceCreatorAttachmentItem';

const TrainerResourceCreator = ({ onCreate }) => {
  ...
  return (
    <Box
      ...
      {attachments.map((attachment, index) => (
        <TrainerResourceCreatorAttachmentItem
          key={index}
...
export default TrainerResourceCreator;
